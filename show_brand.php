      ...
      <div class="inside">
       <?php
        ...
        while($dbarr= mysql_fetch_array($result)){       
          ...
          echo "    <td width=100 align=center><a href=update_brand.php?adid=$dbarr[brand_id]>Edit</a></td>";
          echo "    <td width=100 align=center><a href=delete_brand.php?adid=$dbarr[brand_id]>Delete</a></td>";
        }mysql_close($link);
        ?>
             </div>
    </section>
