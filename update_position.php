...
<div class="wrap">
  ...
  <div class="container">
    <aside>
      ...
      <div class="inside">
          <table width=500 border=0><tr><td align=center><h2>แก้ไขรายการตำแหน่ง</td></tr></table>
          <?php
if ($send==NULL){

echo "<form method=post action=$php_self>";
    $sql= "select * from tbposition where position_id = '$adid';";
    $result=  mysql_query($sql);
    
    $dbarr =  mysql_fetch_array($result);
    echo "รหัสตำแหน่ง: ".$adid."<br>";
    echo "ชื่อตำแหน่ง: ";
    echo "<input type=text name=Ename Value=$dbarr[position_name]><br>";
    ...
    $sql = "update tbposition set position_name='$Ename' where position_id='$adid'";
        $result = mysql_query($sql);
            if ($result){
